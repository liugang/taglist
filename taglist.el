...
(defun taglist-detect-language-by-major-mode ()
  ...
  (let ((language nil))
    ...
    (cond
     ...
     ((string= "rst-mode" taglist-current-major-mode)
      (setq language "rst")
      )
     ((string= "awk-mode" taglist-current-major-mode)
      (setq language "awk")
      )
     ((string= "html-mode" taglist-current-major-mode)
      (setq language "html")
      )
     ((string= "latex-mode" taglist-current-major-mode)
      (setq language "tex")
      )
     ((string= "scheme-mode" taglist-current-major-mode)
      (setq language "scheme")
      )
     ((string= "lisp-mode" taglist-current-major-mode)
      (setq language "lisp")
      )
     ((string= "fortran-mode" taglist-current-major-mode)
      (setq language "fortran")
      )
     ((string= "pascal-mode" taglist-current-major-mode)
      (setq language "pascal")
      )
     ((string= "perl-mode" taglist-current-major-mode)
      (setq language "perl")
      )
     ((string= "makefile-gmake-mode" taglist-current-major-mode)
      (setq language "make")
      )
     ((string= "asm-mode" taglist-current-major-mode)
      (setq language "asm")
      )
     ((string= "sh-mode" taglist-current-major-mode)
      (setq language "sh")
      )
     ((string= "sql-mode" taglist-current-major-mode)
      (setq language "sql")
      )
     ((string= "vhdl-mode" taglist-current-major-mode)
      (setq language "vhdl")
      )
     ((string= "tcl-mode" taglist-current-major-mode)
      (setq language "tcl")
      )
     ((string= "f90-mode" taglist-current-major-mode)
      (setq language "fortran")
      )
     ((string= "javascript-mode" taglist-current-major-mode)
      (setq language "javascript")
      )
     ((string= "verilog-mode" taglist-current-major-mode)
      (setq language "verilog")
      )
     ((string= "shell-script-mode" taglist-current-major-mode)
      (setq language "sh")
      )
